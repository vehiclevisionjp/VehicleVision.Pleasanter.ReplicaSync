...
デスクトップアプリ（サーバ不要）を使用する場合は、[デスクトップアプリ インストールガイド](docs/wiki/installation-desktop.md)を参照してください。
